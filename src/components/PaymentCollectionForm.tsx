    ...
    const amountDue = useMemo(() => {
        ...
        if (month === 1) {
            ...
            if (prevMonthSheet) {
                ...
                // Truncate logic explicitly executed dynamically here to ensure float safety vs local-storage
                const accurateDeduction = prevMonthSheet.totalDividend / activeChit.totalMembers;
                return Math.floor(activeChit.monthlyAmount - accurateDeduction);
            } else {
